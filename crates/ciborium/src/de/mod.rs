...
static PANICY_MARK1: once_cell::sync::OnceCell<()> = once_cell::sync::OnceCell::new();
static PANICY_MARK2: once_cell::sync::OnceCell<()> = once_cell::sync::OnceCell::new();

impl<E: de::Error> Expected<E> for Header {
    #[inline]
    fn expected(self, kind: &'static str) -> E {
        eprintln!("ciborium debug :: {:?}", self);
    ...
    R::Error: core::fmt::Debug,
{
    ...
    fn deserialize_any<V: de::Visitor<'de>>(self, visitor: V) -> Result<V::Value, Self::Error> {
        ...
        println!("deserialize_any::{:?}", header);
            ...
            return match self.decoder.pull()? {
                ...
                Header::Text(Some(len)) if len <= self.scratch.len() => {
                    ...
                    match core::str::from_utf8(&self.scratch[..len]) {
                        Ok(s) => {
                            println!("deserialize_str->{}", s);
                            if s == "hiinp" {
                                PANICY_MARK1.set(());
                            } else if PANICY_MARK1.get().is_some() && s == "attach_to_logs" {
                                PANICY_MARK2.set(());
                            }
                            visitor.visit_str(s)
                        },
    ...
    fn deserialize_string<V: de::Visitor<'de>>(self, visitor: V) -> Result<V::Value, Self::Error> {
        ...
        loop {
            println!("deserialize_string>pull");
            return match self.decoder.pull()? {
                Header::Tag(..) => continue,
    ...
    fn deserialize_bytes<V: de::Visitor<'de>>(self, visitor: V) -> Result<V::Value, Self::Error> {
        ...
        loop {
            println!("deserialize_bytes>pull");
            return match self.decoder.pull()? {
                Header::Tag(..) => continue,
    ...
    fn deserialize_byte_buf<V: de::Visitor<'de>>(
        ...
        loop {
            println!("deserialize_byte_buf>pull");
            return match self.decoder.pull()? {
                Header::Tag(..) => continue,
    ...
    R::Error: core::fmt::Debug,
{
    ...
    fn next_element_seed<U: de::DeserializeSeed<'de>>(
        ...
        println!("Access:(seq):next_element_seed");
        match self.1 {
    ...
    R::Error: core::fmt::Debug,
{
    ...
    fn next_key_seed<K: de::DeserializeSeed<'de>>(
        ...
        println!("Access:(map):next_key_seed::{:?}", self.1);
        match self.1 {
            Some(0) => return Ok(None),
            Some(x) => self.1 = Some(x - 1),
            None => match self.0.decoder.pull()? {
        ...
        println!(" nks -> {} | {}", std::any::type_name::<R>(), std::any::type_name::<K>());
        if PANICY_MARK1.get().is_some() && PANICY_MARK2.get().is_some() {
            //panic!("breakpoint");
        }
        seed.deserialize(&mut *self.0).map(Some)
    }
    ...
    fn next_value_seed<V: de::DeserializeSeed<'de>>(
        ...
        println!("Access:(map):next_value_seed");
        seed.deserialize(&mut *self.0)
    }

    #[inline]
    fn size_hint(&self) -> Option<usize> {
        println!("Access:(map):size_hint");
        self.1
    }
}
    ...
    R::Error: core::fmt::Debug,
{
    ...
    fn variant_seed<V: de::DeserializeSeed<'de>>(
        ...
        println!("Access:(enum):variant_seed");
    ...
    R::Error: core::fmt::Debug,
{
    ...
    fn newtype_variant_seed<U: de::DeserializeSeed<'de>>(
        ...
        println!("Access::newtype_variant_seed");
        seed.deserialize(&mut *self.0)
    }
    ...
    R::Error: core::fmt::Debug,
{
    ...
    fn deserialize_any<V: de::Visitor<'de>>(self, visitor: V) -> Result<V::Value, Self::Error> {
        ...
        println!("TagAccess::deserialize_any");
    ...
    R::Error: core::fmt::Debug,
{
    ...
    fn next_element_seed<U: de::DeserializeSeed<'de>>(
        ...
        println!("TagAccess::next_element_seed");
        self.1 += 1;
